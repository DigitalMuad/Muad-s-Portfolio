...
const PIKCHA_PATTERN = /pikcha|image editor|image processing|image enhancement|image compression/i;
const CRYPTORAGE_PATTERN = /cryptorage|chrome extension|secure storage|dorahacks|walrus blockchain/i;
const TERMINAL_AI_PATTERN = /terminal ai|assistant|cli tool|command line|npm package|terminal-ai-assistant/i;
const GITSPLIT_PATTERN = /gitsplit|funding platform|open source|github|ethereum/i;
...
function detectQueryType(message: string): string | null {
  ...
  if (PIKCHA_PATTERN.test(lowerMessage)) return "pikcha_project";
  if (CRYPTORAGE_PATTERN.test(lowerMessage)) return "cryptorage_project";
  if (TERMINAL_AI_PATTERN.test(lowerMessage)) return "terminal_ai_project";
  if (GITSPLIT_PATTERN.test(lowerMessage)) return "gitsplit_project";
      ...
      const response = await fetch(
        "https://openrouter.ai/api/v1/chat/completions",
        {
          ...
          headers: {
            ...
            "HTTP-Referer": "https://muadmahdi.com",
            "X-Title": "Muad Mahdi's Portfolio",
...
function generateStructuredResponse(queryType: string): string {
  ...
  const projectTemplates: Record<string, any> = {
    pikcha_project: [
      {
        title: "Pik-cha",
        description: "A web platform that allows users to transform, enhance, and optimize images using advanced AI tools. Features include seamless image editing, background removal, smart enhancement, and efficient compression.",
        technologies: ["JavaScript", "React", "Flask", "Tailwind CSS", "Rembg", "Pillow", "Render"],
    ...
    cryptorage_project: [
      {
        title: "Cryptorage",
        description: "Chrome extension using React.js and Supabase for secure data storage with blockchain integration.",
        technologies: ["React.js", "Supabase", "Walrus Blockchain", "OCR", "Gemini Nano"],
    ...
    terminal_ai_project: [
      {
        ...
        description: "Node.js CLI tool that converts natural language into Windows command line instructions.",
    ...
    gitsplit_project: [
      {
        title: "Gitsplit",
        description: "A funding platform for open-source projects using Next.js, Golang, and PostgreSQL.",
  ...
  const linkTemplates: Record<string, any> = {
    resume_link: [
      {
        title: "Resume",
        url: "https://muadmahdi.com/resume",
        description:
    ...
    linkedin_link: [
      {
        ...
        url: "https://www.linkedin.com/in/muad-mahdi-949003295/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3BClR8j6hbRI%2BSt41IAFSfKw%3D%3D",
    ...
    portfolio_link: [
      {
        ...
        url: "https://muadmahdi.com/",
        description: "My personal portfolio showcasing projects and skills",
      },
    ],
    project_links: [
      {
        title: "Pik-cha Project",
    ...
    projects: [
      {
        title: "Pik-cha",
        description:
          "An AI-powered image transformation platform  that empowers users to transform, enhance, and optimize images using advanced AI tools. It enables seamless image editing, background removal, smart enhancement, and efficient compression, all within an intuitive interface. Pik-Cha is designed for individuals and teams to securely manage and share images, ensuring privacy and quality with every transformation.",
        technologies: ["JavaScript", "React", "Flask", "Tailwind CSS", "Rembg", "Pillow", "Render"],
        link: "https://pik-cha.onrender.com/",
      },
      /*
    ...
    experience: [
      {
        ...
        description: "Completed an intensive bootcamp program focused on full-stack web development. Built real-world projects using JavaScript, Python, React, Flask, and databases.",
      },
    ],
    education: [
      {
        ...
        period: "2023 - 2026",
        description: "Currently in final year pursuing a degree in Software Development, focusing on software development and computer science fundamentals.",
      },
    ],
    contact: {
      email: "muadmahdi514@gmail.com",
      phone: "+254722426339",
      location: "Nairobi, Kenya",
      linkedin: "https://www.linkedin.com/in/muad-mahdi-949003295/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3BClR8j6hbRI%2BSt41IAFSfKw%3D%3D",
      github: "https://github.com/DigitalMuad",
      portfolio: "https://muadmahdi.com/",
    },
    awards: [
      {
        title: "Moringa School Certification",
        description: "Completed Full-Stack Software Development bootcamp with focus on modern web technologies and best practices.",
      },
    ],
    links: [
      {
  ...
  try {
    ...
    async function callModel(state: typeof MessagesAnnotation.State) {
      try {
        ...
        let systemContent = `You are Muad Mahdi, a full-stack developer with expertise in JavaScript, React, Python, and Node.js. You are currently pursuing a Bachelor's degree in Software Development at KCA University, Nairobi, Kenya.`;
        ...
        systemContent += `\n\nRules:
        1. Speak as Muad using "I" and "my"
