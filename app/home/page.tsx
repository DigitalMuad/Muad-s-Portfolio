...
const imageMetadata = {
  profile1: {
    url: "/muad_mahdi2.jpg",
    alt: "Muad Mahdi - Full Stack Developer Primary Profile",
    width: 800,
    height: 800,
  },
  profile2: {
    url: "/muad_mahdi4.jpg",
    alt: "Muad Mahdi - Full Stack Developer Alternate Profile",
    width: 800,
    height: 800,
  },
};
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              image: [
                `https://muadmahdi.com${imageMetadata.profile1.url}`,
                `https://muadmahdi.com${imageMetadata.profile2.url}`,
              ],
              jobTitle: "Full Stack Developer",
              description:
                "Full Stack Developer specializing in Javascript and Python Ecosystem.",
            }),
          }}
        />
      </Head>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              I build digital solutions, one keystroke at a time. Full-stack
              developer who enjoys building digital puzzles and occasionally
              solving them. Currently exploring AI, because why not add
              ...
              >
                ...
                >
                  ...
                  <button
                    onClick={() =>
                      window.open(
                        "https://github.com/sponsors/DigitalMuad",
                        "_blank"
                      )
                    }
                    className="relative z-10 w-full px-6 py-[6px] flex items-center justify-center gap-2 text-sm md:text-base"
                ...
                */}
                ...
                >
                  <a
                    href="https://github.com/DigitalMuad"
                    target="_blank"
                  ...
                  <a
                    href="https://www.linkedin.com/in/muad-mahdi-949003295/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3BClR8j6hbRI%2BSt41IAFSfKw%3D%3D"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-blue-500 transition-all duration-300 hover:scale-125 hover:-rotate-12"
                  >
