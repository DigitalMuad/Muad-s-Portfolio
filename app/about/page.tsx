          ...
          <div id="about-container" className="max-w-4xl">
            ...
            >
              ...
              >
                ...
                I play around Javascript and Python ecosystems for my web dev
                projects.
              </p>
              ...
              <p
                ...
                className="text-lg md:text-xl text-neutral-300 leading-relaxed"
              >
                Currently I&apos;m diving into AI after watching
                many cool projects built around Artificial Intelligence and i&apos;m
