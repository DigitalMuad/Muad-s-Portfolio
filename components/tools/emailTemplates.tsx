...
export const emailTemplates: EmailTemplate[] = [
  {
    ...
    prompt:
      "Generate a professional email introducing myself as a software developer looking to connect with potential clients or employers. Include my expertise in React, Javascript, and Python.",
  ...
  },
  {
    ...
    prompt:
      "Create a project proposal email for a potential client. The project involves building a modern web application with React and Javascript. Include sections about timeline, approach, and why I'm the right developer for the job.",
  ...
  },
  {
    ...
    prompt: `Write a professional email as a tech recruiter reaching out to hire Muad Mahdi. Include these details:
  ...
  I've reviewed your portfolio projects and your experience with modern web technologies and blockchain development aligns perfectly with what we're looking for. Let's schedule a call to discuss this opportunity in detail.`,
